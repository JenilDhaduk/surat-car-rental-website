...
<section id="banner" class="banner-section">
  <div class="container">
    <div class="div_zindex">
      <div class="row">
        <div class="col-md-10 col-md-push-7" style="left: 20%; padding: 0px 0px 150px 150px;">
          <div class="banner_content">
            <h1 class="animate-text">Find the ideal car for you.</h1>
            <p class="animate-text">Explore our extensive selection and choose the perfect car for your journey. Quality, comfort, and reliability, all in one place.</p>
          </div>
        </div>
      </div>
    </div>
